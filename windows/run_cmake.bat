...
set CMAKE_ARGS=%CMAKE_ARGS% -DBUILD_SHARED_LIBS=OFF -DHUNTER_BUILD_SHARED_LIBS=OFF -Dstatic_runtime=ON
...
set CMAKE_ARGS=%CMAKE_ARGS% -DSILKWORM_CORE_ONLY=OFF -DSILKWORM_WASM_API=ON
